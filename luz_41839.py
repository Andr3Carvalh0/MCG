...
class LuzPontual:
    ...
    def __str__(self):
        return "LuzPontual(" + str(self.posicao) + ", " + str(self.intensidade_ambiente) + ", " + str(self.intensidade_difusa) + ", " + str(self.intensidade_especular) + ")"
...
if __name__ == "__main__":
    ...
    print()
    print("teste a get_intensidade_ambiente")
    print(luz.get_intensidade_ambiente())
    
    print()
    print("teste a get_intensidade_difusa")
    print(luz.get_intensidade_difusa())
    
    print()
    print("teste a get_intensidade_especular")
